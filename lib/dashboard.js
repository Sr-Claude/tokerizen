...
<div class="container">
  <header>
    ...
    <p class="subtitle">v3.3 — Proxy de optimización de tokens para Anthropic · Fable 5, Opus, Sonnet, Haiku · streaming + batch</p>
  </header>
  ...
  function refresh() {
    Promise.all([
      ...
      var cards = [
        ...
        ['Ahorro USD', '$' + d.estimatedSavingsUSD, 'a $3/M tokens'],
